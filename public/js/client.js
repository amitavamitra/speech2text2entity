...
var finaliseTranscription = document.getElementById('finaliseTranscription');

finaliseTranscription.addEventListener('click',function(){
	document.getElementById('transcript').innerText = fdata;
	socket.emit('text',fdata)
})
...
socket.on('connect', function (data) {
	// function call table and populate entities
});
